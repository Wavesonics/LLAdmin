 ...
 * {@link LaunchSelectedCallback} interface
 * to listen for item selections.
 */
public class LaunchListActivity extends Activity implements LaunchSelectedCallback
{
	/**
	...
	protected void onCreate( final Bundle savedInstanceState )
	{
		...
		if( findViewById( R.id.launch_detail_container ) != null )
		{
			...
			((LaunchListFragment) getFragmentManager()
	...
	/**
	 * Callback method from {@link LaunchSelectedCallback}
	...
	public void onItemSelected( final int id )
	{
		if( m_twoPane )
		{
			...
			arguments.putInt( LaunchDetailFragment.ARG_ITEM_ID, id );
		...
		else
		{
			...
			detailIntent.putExtra( LaunchDetailFragment.ARG_ITEM_ID, id );
